		...
		<div class="dancakes">
			...
			<div class="section group" style="padding-top:60px">
				...
				<div class="col span_3_of_12">
					<img src="img/gopro.jpg" height="280" width="280" alt="gopro hero 5 image">
				</div>
				<div class="col span_4_of_12">
					<div class ="productcat" id="productcat2">
						GoPro Hero 5<br>
						$500.00
					</div>
				</div>
				<div class="col span_4_of_12">
					<div class ="productcat" id="productcat2">
						ORDER SUMMARY<br>
						TOTAL: $500.00<br>
						 <a href='fulfillment.php'><button type="button">chekout</button></a>
					</div>
				</div>
			</div>
			</div>
