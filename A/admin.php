		...
		<div class="dancakes">
			...
			<div class="section group" style="padding-top:60px">
				<div class="col span_12_of_12">
					...
					<div class="col span_12_of_12">
						<div class="products">
							<img src="img/admin.jpg" height="100" width="100" alt="admin photo">
						</div>
					</div>
				</div>
				<div class="col span_12_of_12">
			...
			<div class="section group" style="padding-top:60px; margin-left:10px; margin-right:10px">
				<div class="col span_4_of_12">
					<div id="discount2">
					 	REGISTERED CLIENTS
					</div>
			...
			<div class="section group" style="padding-top:30px; padding-bottom:30px; margin-left:10px; margin-right:10px">
