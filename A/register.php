		...
		<div class="dancakes">
			...
			<div class="section group" style="padding-top:60px">
				...
				<div class="section group" style="padding-top:60px margin-bottom:60px ">
					...
					<div class="col span_4_of_12">
						<div class="loginform">
            				<form id="RegisterForm" action='<?php echo $functions->GetSelfScript(); ?>' method="post" accept-charset='UTF-8'>
					            ...
					            <div>
					            	<input type='text' name='firstName' class="form_input required" id='firstName' value="" placeholder="first name" />
					            </div>
					            <div>
					            	<input type='text' name='lastName' class="form_input required" id='lastName' value="" placeholder="last name" />
					            </div>
					            <div>
