<?PHP
  ...
  {
  	header("Location: http://sulley.cah.ucf.edu/~dig4530c_009/A/signin.php");
  }

  if(isset($_POST['submittedDelete']))
  {
     if($functions->DeleteAccount())
     {
     	header("Location: http://sulley.cah.ucf.edu/~dig4530c_009/A/home.php");
     }
  }
?>
<!DOCTYPE html>
		...
		<div class="dancakes">
			...
			<div class="section group" style="padding-top:60px">
				<div class="col span_12_of_12">
					...
					<div class="col span_12_of_12">
						<div class="products">
							<img src="img/clientphoto.jpg" height="100" width="100" alt="admin photo">
						</div>
					</div>
				</div>
				<div class="col span_12_of_12">
					<div class ="productname" id="productname1">
						Adele Send MyLove
					</div>
					<div class ="productcat" id="productcat1">
						You don't know me, you don't know my story, you don't know how many microphones I can buy.
					</div>
			...
			<div class="section group" style="padding-top:30px; margin-left:10px; margin-right:10px">
				...
				<div class="col span_6_of_12">
					<div id="discount2">
					 	CLIENT'S NEWSLETTER SUBSCIPTION
					</div>
				</div>
			</div>
			<div class="section group" style="margin-left:10px; margin-right:10px">
				<div class="col span_6_of_12">
					<div id="discount2">
			...
			<div class="section group" style="padding-bottom:30px; margin-left:10px; margin-right:10px">
				<div class="col span_12_of_12">
					<div id="discount2">
					 	CLIENT'S RECENT ORDERS CHART
					</div>
				</div>
			</div>
			</div>
